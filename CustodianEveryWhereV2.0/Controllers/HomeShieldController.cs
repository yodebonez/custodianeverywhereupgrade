...
namespace CustodianEveryWhereV2._0.Controllers
{
    ...
    public class HomeShieldController : ApiController
    {
        private static Logger log = LogManager.GetCurrentClassLogger();
        private store<ApiConfiguration> _apiconfig = null;
        private Utility util = null;
        private store<HomeShield> _homeShield = null;
        public HomeShieldController()
        {
        ...
        public async Task<notification_response> BuyHomeShieldInsurance(HomeShieldViewModel homeShield)
        {
            try
            {
                ...
                var filepath = $"{ConfigurationManager.AppSettings["DOC_PATH"]}/Documents/HomeShield/{nameurl}";
