...
namespace CustodianEveryWhereV2._0.Controllers
{
    ...
    public class EDMSGeneralClaimsController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpGet("{merchant_id?}/{claim_number?}")]
        [ValidateJWT]
        ...
        /// <returns></returns>
        [HttpGet("{merchant_id?}/{policy_number?}/{Include_vehicle_list?}")]
        [ValidateJWT]
        ...
        [HttpGet("{merchant_id?}/{proposal_number?}")]
        [ValidateJWT]
